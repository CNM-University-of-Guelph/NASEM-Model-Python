...
def calculate_An_data_initial(animal_input: dict, 
    ...
    an_data["An_DMIn"] = calculate_An_DMIn(Dt_DMIn,
    ...
    # the correct value
    An_GasEOut_Dry = calculate_An_GasEOut_Dry(Dt_DMIn,
                                              diet_data["Dt_FAIn"],
                                              infusion_data["InfRum_FAIn"],
                                              infusion_data["InfRum_DMIn"],
                                              an_data["An_GEIn"])
    An_GasEOut_Lact = calculate_An_GasEOut_Lact(Dt_DMIn,
                                                diet_data["Dt_FAIn"],
                                                infusion_data["InfRum_FAIn"],
                                                infusion_data["InfRum_DMIn"],
                                                an_data["An_DigNDF"])
...
def calculate_An_data_complete(An_data_initial: dict,
    ...
    an_data["An_DEInp"] = calculate_An_DEInp(
        an_data["An_DEIn"], an_data["An_DETPIn"],
        an_data["An_DENPNCPIn"])
    an_data["An_TPIn"] = calculate_An_TPIn(diet_data["Dt_TPIn"],
    ...
    an_data["An_St"] = calculate_An_St(an_data["An_StIn"],
                                                DMI,
                                                infusion_data["InfRum_DMIn"],
                                                infusion_data["InfSI_DMIn"])
    ...
    an_data["An_rOM"] = calculate_An_rOM(an_data["An_rOMIn"],
                                                  DMI,
                                                  infusion_data["InfRum_DMIn"],
                                                  infusion_data["InfSI_DMIn"])
    ...
    an_data["An_ADF"] = calculate_An_ADF(an_data["An_ADFIn"],
                                                  DMI,
                                                  infusion_data["InfRum_DMIn"],
                                                  infusion_data["InfSI_DMIn"])
    an_data["An_CPIn_g"] = calculate_An_CPIn_g(
        an_data["An_CPIn"])
    an_data["An_CP"] = calculate_An_CP(an_data["An_CPIn"],
                                                DMI,
                                                infusion_data["InfRum_DMIn"],
                                                infusion_data["InfSI_DMIn"])
    an_data["An_NIn_g"] = calculate_An_NIn_g(
        an_data["An_CPIn"])
    an_data["An_FAhydrIn"] = calculate_An_FAhydrIn(
        diet_data["Dt_FAhydrIn"], infusion_data["Inf_FAIn"])
    an_data["An_FA"] = calculate_An_FA(an_data["An_FAIn"],
                                                DMI,
                                                infusion_data["InfRum_DMIn"],
                                                infusion_data["InfSI_DMIn"])
    ...
    an_data["An_Ash"] = calculate_An_Ash(an_data["An_AshIn"],
                                                  DMI,
                                                  infusion_data["InfRum_DMIn"],
                                                  infusion_data["InfSI_DMIn"])
    ...
    an_data["An_DigNtIn_g"] = calculate_An_DigNtIn_g(
        an_data["An_DigCPtIn"])
    an_data["An_DigTPtIn"] = calculate_An_DigTPtIn(
        an_data["An_RDTPIn"], Fe_MiTP, an_data["An_idRUPIn"],
        Fe_NPend)
    an_data["An_DigCPt"] = calculate_An_DigCPt(
        an_data["An_DigCPtIn"], an_data["An_DMIn"],
        infusion_data["InfArt_DMIn"])
    an_data["An_DigTPt"] = calculate_An_DigTPt(
        an_data["An_DigTPtIn"], an_data["An_DMIn"],
        infusion_data["InfArt_DMIn"])
    an_data["TT_dcAnCPt"] = calculate_TT_dcAnCPt(
        an_data["An_DigCPtIn"], an_data["An_CPIn"],
        infusion_data["InfArt_CPIn"])
    an_data["TT_dcAnTPt"] = calculate_TT_dcAnTPt(
        an_data["An_DigTPtIn"], an_data["An_TPIn"],
    ...
    an_data["An_idCPIn"] = calculate_An_idCPIn(
        an_data["An_idRUPIn"], Du_idMiCP)
    an_data["An_DigFA"] = calculate_An_DigFA(
        an_data["An_DigFAIn"], DMI, infusion_data["InfRum_DMIn"],
        infusion_data["InfSI_DMIn"])
    ...
    an_data["An_DigOMaIn_Base"] = calculate_An_DigOMaIn_Base(
        an_data["An_DigNDFIn_Base"],
        an_data["An_DigStIn_Base"], an_data["An_DigFAIn"],
    ...
    an_data["An_DigOMaIn"] = calculate_An_DigOMaIn(
        an_data["An_DigNDFIn"], an_data["An_DigStIn"],
        an_data["An_DigFAIn"], an_data["An_DigrOMaIn"],
        an_data["An_DigCPaIn"])
    an_data["An_DigOMtIn"] = calculate_An_DigOMtIn(
        an_data["An_DigNDFIn"], an_data["An_DigStIn"],
        an_data["An_DigFAIn"], an_data["An_DigrOMtIn"],
        an_data["An_DigCPtIn"])
    ...
    an_data["An_DigOMa"] = calculate_An_DigOMa(
        an_data["An_DigOMaIn"], DMI, infusion_data["InfRum_DMIn"],
        infusion_data["InfSI_DMIn"])
    an_data["An_DigOMt"] = calculate_An_DigOMt(
        an_data["An_DigOMtIn"], DMI, infusion_data["InfRum_DMIn"],
        infusion_data["InfSI_DMIn"])
    an_data["An_GEIn"] = calculate_An_GEIn(
        diet_data["Dt_GEIn"], infusion_data["Inf_NDFIn"],
        infusion_data["Inf_StIn"], infusion_data["Inf_FAIn"],
        ...
        infusion_data["Inf_AcetIn"], infusion_data["Inf_PropIn"],
        infusion_data["Inf_ButrIn"], coeff_dict)
    an_data["An_GE"] = calculate_An_GE(an_data["An_GEIn"],
                                                an_data["An_DMIn"])
    ...
    an_data["An_DE"] = calculate_An_DE(an_data["An_DEIn"],
                                                an_data["An_DMIn"])
