...
@pytest.fixture
def micronutrient_requirement_data():
    return pd.read_json("./tests/micronutrient_requirement_equations_test.json")


def test_from_json(micronutrient_requirement_data):
    for index, row in micronutrient_requirement_data.iterrows():
        try:
