...
@pytest.fixture
def microbial_protein_data():
    return pd.read_json("./tests/microbial_protein_equations_test.json")


def test_from_json(microbial_protein_data):
    for index, row in microbial_protein_data.iterrows():
        try:
